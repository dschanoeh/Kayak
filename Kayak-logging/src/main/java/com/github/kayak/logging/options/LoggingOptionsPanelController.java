...
@OptionsPanelController.TopLevelRegistration(categoryName = "#OptionsCategory_Name_Logging",
iconBase = "com/github/kayak/logging/options/accessories-text-editor.png",
keywords = "#OptionsCategory_Keywords_Logging",
